...
@section('content')
    ...
    <div class="flex items-center justify-between mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Add Investment</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
        <form action="{{ route('investments.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" required>
            </div>
                ...
                <select id="investment_type_id" name="investment_type_id" class="w-full border border-gray-300 rounded-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-gray-400" required>
                    ...
                    @foreach ($investmentTypes as $investmentType)
                        <option
                            ...
                            data-category="{{ $investmentType->category_id }}"
                        >
                            {{ $investmentType->name }}
                        </option>
                    @endforeach
            ...
            <div class="mb-5">
                ...
                <input type="text" id="provider" name="provider" value="{{ old('provider') }}" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" required>
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="number" id="invested_amount" name="invested_amount" value="{{ old('invested_amount') }}" step="0.01" min="0" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" required>
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="number" id="current_value" name="current_value" value="{{ old('current_value') }}" step="0.01" min="0" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" required>
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="date" id="investment_date" name="investment_date" value="{{ old('investment_date') }}" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" required>
            </div>
            ...
            <div class="mb-5">
                ...
                <textarea id="notes" name="notes" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('notes') }}</textarea>
            </div>

            

            <button type="submit" class="bg-gray-800 text-white px-5 py-2 rounded-lg hover:bg-gray-700">Save Investment</button>
    ...
    categorySelect.addEventListener('change', function () {
        ...
        allInvestmentTypes.forEach(function (option) {
            ...
            if (option.dataset.category === selectedCategoryId) {
                investmentTypeSelect.appendChild(option.cloneNode(true));
            }
